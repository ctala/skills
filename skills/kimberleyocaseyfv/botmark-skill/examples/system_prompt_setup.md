...
Set your BotMark API key as an environment variable — **do NOT embed it in the system prompt**:
...
If you want the bot to autonomously run evaluations when prompted, append the contents of `system_prompt_en.md` (English) or `system_prompt.md` (Chinese) to your bot's system prompt. This is optional — without it, the bot can still use the registered tools manually.
