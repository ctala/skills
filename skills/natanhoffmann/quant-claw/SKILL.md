...
metadata:
  openclaw:
    ...
    install:
      - id: purchase
        kind: manual
        label: "Purchase QuantClaw ($97) — includes install instructions"
        url: "https://quantclaw.gumroad.com/l/wugjom"
    envDocs:
    ...
    safetyNote: "DEMO mode is the default. Switching to LIVE requires explicit user confirmation. Never supply live keys with withdrawal permissions."
---
