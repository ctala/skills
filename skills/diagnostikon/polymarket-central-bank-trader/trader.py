...
KEYWORDS = ['Federal Reserve', 'Fed rate', 'FOMC', 'interest rate', 'ECB', 'rate cut', 'rate hike', 'inflation', 'CPI', 'PCE', 'Jerome Powell', 'Riksbank', 'Bank of England', 'quantitative easing', 'QE', 'yield curve', 'recession', 'soft landing', 'stagflation']
...
def run(live: bool = False) -> None:
    ...
    print(f"[polymarket-central-bank-trader] mode={mode} max_pos=${MAX_POSITION} min_vol=${MIN_VOLUME} max_spread={MAX_SPREAD:.0%} min_days={MIN_DAYS}")
