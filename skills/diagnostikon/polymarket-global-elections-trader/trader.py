...
Trades Polymarket prediction markets on elections, referendums, and democratic events worldwide — outside the US (which is heavily covered). Focuses on EU, Latin America, Asia, and Africa.
...
KEYWORDS = ['election', 'referendum', 'vote', 'prime minister', 'chancellor', 'president', 'Germany election', 'France election', 'Brazil election', 'India election', 'UK election', 'Japan election', 'South Korea', 'Taiwan election', 'snap election', 'coalition', 'majority', 'parliament', 'polling', 'exit poll', 'swing state', 'incumbent']
...
if __name__ == "__main__":
    ap = argparse.ArgumentParser(description="Trades Polymarket prediction markets on elections, referendums, and democratic events worldwide — outside the US (which is heavily covered). Focuses on EU, Latin America, Asia, and Africa.")
